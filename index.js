        ...
        function _callee3$(_context3) {
          while (1) {
            switch ((_context3.prev = _context3.next)) {
              ...
              case 11:
                throw new Error(
                  'invalid typename or terms: '.concat(typenameOrTerms)
                )
                ...
                _loop = function _loop() {
                  ...
                  if (
                    every(terms, function(_ref3) {
                      ...
                      return (0,
                      _doesQueryContain.default)(document, types, typename, data, predicate != null ? normalizePredicate(predicate, idField || 'id') : null)
                    })
                  ) {
